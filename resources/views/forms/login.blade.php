    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" action="{{url('user/login')}}" method="post">
                    @csrf
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button class="login100-form-btn " type="submit"  >Log in
                            </button>

                        </div>
                    </div>

                    <div style="float:left;margin-left: 38px;margin-top: 15px">
                        <a href="{{url('/').'/'."login/facebook"}}">
                            <i class="fab fa-facebook-square fa-3x ml-2"></i>  </a>
                        <a href='#'>
                            <i class="fab fa-twitter-square fa-3x ml-2"></i>
                        </a>
                        <a href='#'>
                            <i class="fab fa-google-plus-square fa-3x ml-2" ></i>
                        </a>
                        <a href='#'>
                            <i class="fab fa-linkedin fa-3x ml-2"></i>  </a>
