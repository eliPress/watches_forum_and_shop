        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" action="{{url('cms/products/allProducts')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="wrap-input100 validate-input">Product Name: 
