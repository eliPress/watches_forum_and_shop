...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" action="{{url('cms/products/allProducts/'.$product->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="wrap-input100 validate-input">Name: 
                            <input class="input100" type="text" name="name" value="{{$product->name}}">
    <!--                        <span class="focus-input100" data-placeholder="Category Name"></span>-->
                        ...
                        <div class="wrap-input100 validate-input">
                            ...
                            <input class="input100" type="text" name="description" value=" {{$product->description}}">
                        ...
                        <div class="wrap-input100 validate-input">
                            ...
                            <input class="input100" type="text" name="price" value=" {{$product->price}}">
