    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" action="{{url('cms/customer/customers')}}" method="post">
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                     ...
                     <div class="wrap-input100 validate-input" data-validate="Enter password">
                        ...
                        <input class="input100" type="password" name="password.confirmation">
                        <span class="focus-input100" data-placeholder="Re confirm"></span>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button class="login100-form-btn " type="submit" onclick="window.location ='{{url('cms/customer/customers')}}'"  >Add Now
                            </button>
